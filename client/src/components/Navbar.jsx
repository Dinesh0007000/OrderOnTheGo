...
const Navbar = () => {
  ...
  const { logout, cartCount, setSearchTerm } = useContext(GeneralContext);
  ...
  const handleSearch = () => {
    setSearchTerm(productSearch.trim().toLowerCase());
    setNoResult(false);
    navigate('/');
  };
        ...
        <div className="navbar">
          ...
          <div className="nav-content">
            <div className="nav-search">
              ...
              {
                noResult === true ?
                  <div className='search-result-data'>no items found.... try searching for restaurant name., <ImCancelCircle className='search-result-data-close-btn' onClick={() => setNoResult(false)} /></div>
                  :
                  ""
              }
            </div>
